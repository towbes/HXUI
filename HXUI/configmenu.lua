...
config.DrawWindow = function(us)
    ...
    if(imgui.Begin(("HXUI Config"):fmt(addon.version), showConfig, bit.bor(ImGuiWindowFlags_NoSavedSettings))) then
        ...
        imgui.BeginChild("Config Options", { 0, 0 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
        if (imgui.CollapsingHeader("General")) then
            imgui.BeginChild("GeneralSettings", { 0, 210 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
        ...
        if (imgui.CollapsingHeader("Player Bar")) then
            imgui.BeginChild("PlayerBarSettings", { 0, 210 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
        ...
        if (imgui.CollapsingHeader("Target Bar")) then
            imgui.BeginChild("TargetBarSettings", { 0, 270 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
        ...
        if (imgui.CollapsingHeader("Enemy List")) then
            imgui.BeginChild("EnemyListSettings", { 0, 180 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
        ...
        if (imgui.CollapsingHeader("Party List")) then
            imgui.BeginChild("PartyListSettings", { 0, 460 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
            ...
            if true then
                imgui.BeginChild('PartyListSettings.Party1', { 0, 230 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
                imgui.Text('Party');
            ...
            if (gConfig.partyListAlliance) then
                imgui.BeginChild('PartyListSettings.Party2', { 0, 205 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
            ...
            if (gConfig.partyListAlliance) then
                imgui.BeginChild('PartyListSettings.Party3', { 0, 205 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
        ...
        if (imgui.CollapsingHeader("Exp Bar")) then
            imgui.BeginChild("ExpBarSettings", { 0, 300 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
        ...
        if (imgui.CollapsingHeader("Gil Tracker")) then
            imgui.BeginChild("GilTrackerSettings", { 0, 160 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
        ...
        if (imgui.CollapsingHeader("Inventory Tracker")) then
            imgui.BeginChild("InventoryTrackerSettings", { 0, 210 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
        ...
        if (imgui.CollapsingHeader("Cast Bar")) then
            imgui.BeginChild("CastBarSettings", { 0, 160 }, ImGuiChildFlags_Borders, ImGuiWindowFlags_None);
